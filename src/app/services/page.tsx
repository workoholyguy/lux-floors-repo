      ...
      <main className="flex-1 flex flex-col gap-16 items-center w-full max-w-5xl mx-auto p-8">
        ...
        <section className="w-full bg-gray-50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
            <div className="bg-gray-200 h-40 rounded-lg flex items-center justify-center text-gray-500">Service 1</div>
            <div className="bg-gray-200 h-40 rounded-lg flex items-center justify-center text-gray-500">Service 2</div>
            <div className="bg-gray-200 h-40 rounded-lg flex items-center justify-center text-gray-500">Service 3</div>
            <div className="bg-gray-200 h-40 rounded-lg flex items-center justify-center text-gray-500">Service 4</div>
            <div className="bg-gray-200 h-40 rounded-lg flex items-center justify-center text-gray-500">Service 5</div>
            <div className="bg-gray-200 h-40 rounded-lg flex items-center justify-center text-gray-500">Service 6</div>
          </div>
        </section>
        <section className="w-full">
